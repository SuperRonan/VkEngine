...
namespace vkl
{
	...
	constexpr static const VkBufferUsageFlags VK_BUFFER_USAGE_TRANSFER_BITS = VK_BUFFER_USAGE_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
	constexpr static const VkBufferUsageFlags2KHR VK_BUFFER_USAGE_2_TRANSFER_BITS_KHR = VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT_KHR | VK_BUFFER_USAGE_2_TRANSFER_DST_BIT_KHR;
	constexpr static const VkImageUsageFlags VK_IMAGE_USAGE_TRANSFER_BITS = VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT;
	constexpr static const VkImageAspectFlags VK_IMAGE_ASPECT_DEPTH_STENCIL_BITS = VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT;

	constexpr static const VkColorComponentFlags VK_COLOR_COMPONENTS_RGB_BITS = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT;
	constexpr static const VkColorComponentFlags VK_COLOR_COMPONENTS_RGBA_BITS = VK_COLOR_COMPONENTS_RGB_BITS | VK_COLOR_COMPONENT_A_BIT;
	...
	{
		VkPipelineStageFlags res = static_cast<VkPipelineStageFlagBits2>(GetPipelineStageFromShaderStage(s));
		return res;
	}
